jQuery(document).ready(function($){
  ...
  var menu_ul = $('#main-nav').find('ul').first();

  var a_element = menu_ul.children('.menu-item-has-children').children('a');

  a_element.attr("data-toggle", "dropdown");
  // a_element.attr({
  ...
  a_element.append('<span class="caret mytheme_menu_switch"></span>');
  a_element.addClass('dropdown-toggle');



  //menu_ul.children('.menu-item-has-children').children('a').append('<span class="caret"></span>');
...
// @codekit-prepend "navigation-custom.js"
